                        ...
                        <div className='grid lg:grid-cols-2 gap-12 flex items-center'>
                            <div className='mt-12 lg:mt-0'>
                                ...
                                <img
                                    ...
                                    className='inline-block px-0 py-3 mr-2  text-white font-medium text-sm leading-snug uppercase rounded focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out'
                                />
                            </div>
                            <div className='mb-12 lg:mb-0'>
                                <img src='src/images/Player.png' className='w-full rounded-lg ' alt='' />
                            </div>
                        </div>
                    </div>
                </div>
