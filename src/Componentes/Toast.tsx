    ...
    return (
        ...
        >
            ...
            <div className='px-4 py-2 -mx-3'>
                <div className='mx-3'>
                    <span className='font-bold text-indigo-600 dark:text-indigo-600'>¡Genial!</span>
                    <p className='text-sm text-indigo-500 dark:text-indigo-500 font-bold'>Jugador agregado exitosamente!</p>
                    <button
                        type='button'
